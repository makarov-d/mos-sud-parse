# `mos-sud-parse`
This repository contains the source code of the script used to collect empirical data on the activities of Moscow's courts in the research «Theoretical Analysis of the Subject and Role of Rhetoric in Terms of Modern Russian Criminal Procedure Reality».
